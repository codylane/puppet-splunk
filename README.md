...
This re-write is due to the number of open pull requests and
code incompatiblities with puppet >= 4 on the existing puppet-splunk
module.
...
RHEL/CentOS 5 is fully supported

###RHEL/CentOS 6

RHEL/CentOS 6 is fully supported
